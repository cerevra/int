...
constexpr int128_t operator "" _int128(const char* n) noexcept;
constexpr int256_t operator "" _int256(const char* n) noexcept;
constexpr int512_t operator "" _int512(const char* n) noexcept;
constexpr uint128_t operator "" _uint128(const char* n) noexcept;
constexpr uint256_t operator "" _uint256(const char* n) noexcept;
constexpr uint512_t operator "" _uint512(const char* n) noexcept;
